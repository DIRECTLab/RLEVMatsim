...
from rlevmatsim.envs.stat_flow_matsim_graph_env import StatFlowMatsimGraphEnv
...
class TensorboardCallback(BaseCallback):
    ...
    Attributes:
        ...
        best_env (StatFlowMatsimGraphEnv): The environment
    ...
    def __init__(self, verbose=0, save_dir=None):
        ...
        self.best_env: StatFlowMatsimGraphEnv = None
    ...
    def _on_step(self) -> bool:
        ...
        for i, infos in enumerate(self.locals["infos"]):
            env_inst: StatFlowMatsimGraphEnv = infos["graph_env_inst"]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train a PPO model on the StatFlowMatsimGraphEnv.",
