 ...
 */
 ...
 package org.matsim.contrib.rlEvWireless.infrastructure;

import org.matsim.api.core.v01.Coord;
import org.matsim.api.core.v01.Id;
import org.matsim.api.core.v01.network.Link;
import org.matsim.contrib.rlEvWireless.charging.ChargingLogic;
// import org.matsim.contrib.rlEvWireless.charging.DynamicChargingLogic;
import java.util.Objects;


import com.google.common.base.Preconditions;
 
 class DynamicChargerImpl implements Charger {

    private final ChargerSpecification specification;
	private final Link link;
	private final ChargingLogic logic;

    DynamicChargerImpl( ChargerSpecification specification, Link link, ChargingLogic logic ) {
